...
const unfundedString = numUnfundedGames === 0 ? "All of our games have been funded!" : `${numUnfundedGames} game(s) still need funding.`;


// create a new DOM element containing the template string and append it to the description container
const descriptionText = document.createElement("p");
descriptionText.innerText = unfundedString;
